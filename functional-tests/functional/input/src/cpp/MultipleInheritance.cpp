...
#include "test/FacetOne.h"
#include "test/FacetTwo.h"
#include "test/TheDiamond.h"
...
class TheDiamondImpl: public test::TheDiamond
{
public:
    TheDiamondImpl( ) = default;
    ~TheDiamondImpl( ) = default;
...
std::shared_ptr<TheDiamond>
MultipleInheritanceFactory::get_the_diamond() {
    return std::make_shared<TheDiamondImpl>();
}
