...
int _InterfaceWithStatic_regularFunction_static(Object _obj, Pointer<Pointer<Void>> _result) {
  String? _result_object = null;
  try {
    _result_object = (_obj as InterfaceWithStatic).regularFunction();
    _result.value = String_toFfi(_result_object);
  } finally {
  }
  return 0;
}
int _InterfaceWithStatic_regularProperty_get_static(Object _obj, Pointer<Pointer<Void>> _result) {
  _result.value = String_toFfi((_obj as InterfaceWithStatic).regularProperty);
  return 0;
}
int _InterfaceWithStatic_regularProperty_set_static(Object _obj, Pointer<Void> _value) {
  try {
...
Pointer<Void> smoke_InterfaceWithStatic_toFfi(InterfaceWithStatic value) {
  ...
  final result = _smoke_InterfaceWithStatic_create_proxy(
    ...
    value,
    Pointer.fromFunction<Uint8 Function(Handle, Pointer<Pointer<Void>>)>(_InterfaceWithStatic_regularFunction_static, __lib.unknownError),
    Pointer.fromFunction<Uint8 Function(Handle, Pointer<Pointer<Void>>)>(_InterfaceWithStatic_regularProperty_get_static, __lib.unknownError),
    Pointer.fromFunction<Uint8 Function(Handle, Pointer<Void>)>(_InterfaceWithStatic_regularProperty_set_static, __lib.unknownError)
  );
  return result;
}
